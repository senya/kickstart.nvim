...
-- Включаем встроенную проверку орфографии глобально
vim.opt.spell = true
...
-- Горячие клавиши для работы с орфографией
...
-- Возвращаем пустую таблицу, так как это не плагин, а просто конфигурация
return {}